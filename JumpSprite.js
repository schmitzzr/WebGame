class JumpSprite {
    ...
    loadAnimations() {
        ...
        // dead -> state = 4
        this.anims[4][0] = new Animator(this.spritesheet, 560, 650, 80, 64, 1, 0.2, false); // facing right

        this.anims[4][1] = new Animator(this.spritesheet, 560, 650, 80, 64, 1, 0.2, true); // facing left
